...
| 决策 | 理由 |
|------|------|
| 200 个四六级核心词 | 覆盖常用高频词汇，满足备考需求 |
| 增量种子按 word 查重 | 加新词不影响已有数据，旧词不重复 |
| 四六级分类 | CET-4/CET-6 是大学生最普遍的英语考试目标 |

## 保活方案

| 决策 | 理由 |
|------|------|
| UptimeRobot 免费方案 | 每月 50 个 monitor，每 5 分钟请求一次，足够 |
| 监控 /login 端点 | 轻量页面，不消耗大量带宽 |
| 不升级 Railway 付费 | 保活免费方案满足需求，无需额外开销 |
